...
const Footer = () => {
	...
	return (
		<div>
			<footer className="px-4 divide-y bg-gray-300 dark:text-gray-100">
				<div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
					...
					<div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
						<div className="space-y-3">
							<h3 className="tracking-wide uppercase dark:text-gray-50">Movie</h3>
							<ul className="space-y-1">
							</ul>
						</div>
						<div className="space-y-3">
							<h3 className="tracking-wide uppercase dark:text-gray-50">Business Partners</h3>
							<div className="grid grid-cols-3 gap-3" style={{width:'110px',height:'110px'}}>
								{arrHeThongRap.map((lo, index) => {
									return <div key={index} >
										<img src={lo.logo} alt='123' />
									</div>
								})}
							</div>
						</div>
						<div className="space-y-3">
							<h3 className="uppercase dark:text-gray-50">Movie service</h3>
							<ul className="space-y-1">
								<li>
