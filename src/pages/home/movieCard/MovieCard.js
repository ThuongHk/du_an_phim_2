...
const MovieCard = ({item}) => {
    return (
        <div className="flex flex-col max-w-xs p-6 space-y-6 overflow-hidden rounded-lg shadow-md dark:bg-gray-900 dark:text-gray-100">
            ...
            <div>
                <img style={{height: '150px'}} src={item.hinhAnh} alt className="object-cover w-full mb-4 h-60 sm:h-96 dark:bg-gray-500" />
                <h2 className="mb-1 text-xl font-semibold">{item.tenPhim}</h2>
                <p className="text-sm dark:text-gray-400">{item.biDanh}</p>
            </div>
